                                ...
                                <li className="comment">
                                    ...
                                    <div className="comment-body">
                                        ...
                                        <div className="comment-author vcard">
                                            <img className="avatar photo" src={require("./../../images/testimonials/pic1.png").default} alt=""/>
                                            ...
                                            <ol className="children">
                                                <li className="comment odd parent">
                                                    <div className="comment-body">
                                                        ...
                                                        <div className="comment-author vcard">
                                                            <img className="avatar photo" src={require("./../../images/testimonials/pic2.png").default} alt=""/>
